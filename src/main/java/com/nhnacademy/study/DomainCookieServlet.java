...
public class DomainCookieServlet extends HttpServlet {
    ...
    private void show(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            out.println("<ul>");
            out.println(
                    "<li><a href='http://a.com:8080/domain-cookie/write?domain=a.com'>set cookie: domain=a.com, path=/</a></li>");
            out.println(
                    "<li><a href='http://a.com:8080/domain-cookie/write?domain=.a.com'>set cookie: domain=.a.com, path=/</a></li>");
            out.println(
                    "<li><a href='http://1.a.com:8080/domain-cookie/write?domain=.1.a.com'>set cookie: domain=.1.a.com, path=/</a></li>");
            out.println(
                    "<li><a href='http://1.a.com:8080/domain-cookie/more/write?domain=.a.com'>set cookie: domain=.a.com, path=/domain-cookie/more</a></li>");
            ...
            out.println(
                    "<li><a href='http://1.a.com:8080/domain-cookie/read'>get cookie: domain=1.a.com</a><br /></li>");
            out.println(
                    "<li><a href='http://2.a.com:8080/domain-cookie/read'>get cookie: domain=2.a.com</a><br /></li>");
            out.println(
                    "<li><a href='http://1.a.com:8080/domain-cookie/more/read'>get cookie: domain=1.a.com, path=/domain-cookie/more/read</a><br /></li>");
            out.println("</ul>");
            out.println("</body>");
            out.println("</html>");
        }
    ...
    private void writeCookie(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Cookie newCookie =
                new Cookie(COOKIE_NAME, req.getRequestURL().append("?").append(req.getQueryString()).toString());
